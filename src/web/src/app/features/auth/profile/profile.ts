...
@Component({
  ...
  template: `
    <div class="min-h-[calc(100vh-80px)] flex items-center justify-center p-4">
      <div class="w-full max-w-2xl bg-card/80 backdrop-blur-xl rounded-2xl shadow-2xl p-8 border border-border">
        <div class="flex flex-col items-center mb-8">
          <div class="w-24 h-24 rounded-full bg-primary/10 flex items-center justify-center mb-4 border border-primary/20 shadow-inner">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
          <div class="p-6 rounded-xl bg-card/40 border border-border/50 flex items-start gap-4 transition-all hover:bg-card/60">
            <div class="w-10 h-10 rounded-lg bg-primary/10 flex items-center justify-center shrink-0">
              <lucide-icon [name]="MailIcon" class="w-5 h-5 text-primary"></lucide-icon>
            </div>
            <div>
              <p class="text-xs font-semibold uppercase tracking-wider text-muted-foreground mb-1">Email Address</p>
          ...
          <div class="p-6 rounded-xl bg-card/40 border border-border/50 flex items-start gap-4 transition-all hover:bg-card/60">
            ...
            <div>
              <p class="text-xs font-semibold uppercase tracking-wider text-muted-foreground mb-1">Account Role</p>
        ...
        <div class="flex justify-center border-t border-border pt-8">
          ...
          >
            <lucide-icon [name]="LogOutIcon" class="w-5 h-5 group-hover:scale-110 transition-transform"></lucide-icon>
            Sign Out
          </button>
        </div>
      </div>
