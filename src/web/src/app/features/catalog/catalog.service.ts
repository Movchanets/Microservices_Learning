...
export class CatalogService {
  ...
  searchProducts(params: ProductSearchParams = {}): Promise<SearchResult<ProductListItem>> {
    ...
    if (params.categoryId) httpParams = httpParams.set('categoryId', params.categoryId);
    if (params.priceMin != null) httpParams = httpParams.set('priceMin', params.priceMin.toString());
    if (params.priceMax != null) httpParams = httpParams.set('priceMax', params.priceMax.toString());
