...
public class SearchQueryTests
{
    ...
    private async Task SeedProductsAsync()
    {
        ...
        var products = new List<ProductSearchDocument>
        {
            new()
            {
                ...
                MinPrice = 59.99m, MaxPrice = 59.99m, Currency = "USD", SkuCount = 1, CategoryId = categoryId1,
            ...
            new()
            {
                ...
                MinPrice = 29.99m, MaxPrice = 29.99m, Currency = "USD", SkuCount = 1, CategoryId = categoryId1,
            ...
            new()
            {
                ...
                MinPrice = 89.99m, MaxPrice = 89.99m, Currency = "USD", SkuCount = 1, CategoryId = categoryId2,
            ...
            new()
            {
                ...
                MinPrice = 24.99m, MaxPrice = 24.99m, Currency = "USD", SkuCount = 1, CategoryId = categoryId2,
            ...
            new()
            {
                ...
                MinPrice = 45m, MaxPrice = 45m, Currency = "USD", SkuCount = 1, CategoryId = categoryId1,
    ...
    public async Task FullTextSearch_ReturnsMatchingProducts()
    {
        ...
        var result = await _fixture.SearchService.SearchAsync(
            new SearchRequest("bluetooth", null, null, null, null, null, null, null, 1, 10));
    ...
    public async Task FilterByCategory_ReturnsOnlyMatchingProducts()
    {
        ...
        var all = await _fixture.SearchService.SearchAsync(new SearchRequest(null, null, null, null, null, null, null, null, 1, 100));
        var electronicsCategoryId = all.Items.First(p => p.CategoryName == "Electronics").CategoryId;

        // Act
        var result = await _fixture.SearchService.SearchAsync(
            new SearchRequest(null, electronicsCategoryId, null, null, null, null, null, null, 1, 10));
    ...
    public async Task Pagination_ReturnsCorrectPage()
    {
        ...
        // Act
        var page1 = await _fixture.SearchService.SearchAsync(new SearchRequest(null, null, null, null, null, null, null, null, 1, 2));
        var page2 = await _fixture.SearchService.SearchAsync(new SearchRequest(null, null, null, null, null, null, null, null, 2, 2));
    ...
    public async Task PriceRangeFilter_ReturnsProductsInRange()
    {
        ...
        // Act
        var result = await _fixture.SearchService.SearchAsync(
            new SearchRequest(null, null, 30m, 60m, null, null, null, null, 1, 100));

        // Assert
        result.Items.Should().NotBeEmpty();
        result.Items.Should().AllSatisfy(p =>
        {
            p.MinPrice.Should().BeGreaterThanOrEqualTo(30m);
            p.MaxPrice.Should().BeLessThanOrEqualTo(60m);
        });
    }
}
